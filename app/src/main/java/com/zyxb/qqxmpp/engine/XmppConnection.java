...
import com.zyxb.qqxmpp.util.FormatTools;
...
public class XmppConnection {
	 ...
	 *
	 * strUrl : * url格式
	 * -http://my.openfire.com:9090/plugins/presence/status?jid=
	 * user1@SERVER_NAME&type=xml
	 *
	 * 返回值 : 0 - 用户不存在; 1 - 用户在线; 2 - 用户离线
	 *
	 * 说明 ：必须要求 OpenFire加载 presence 插件，同时设置任何人都可以访问
	 */
	public int IsUserOnLine2(String user) {
		String url = "http://" + SERVER_HOST + ":9090/plugins/presence/status?"
				+ "jid=" + user + "@" + SERVER_NAME + "&type=xml";
		int shOnLineState = 0;
		// 不存在
